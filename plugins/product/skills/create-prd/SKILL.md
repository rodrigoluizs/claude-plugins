---
name: create-prd
description: This skill should be used when the user asks to "create a PRD", "write a product requirement document", "draft a PRD", "new feature PRD", "product requirements", "create product spec", or needs to define a feature from a product perspective and create a GitHub issue for it.
---
