...
description: "Use when reviewing, triaging, or merging open PRs from dependency bots (e.g. Renovate, Dependabot), or when the user asks to handle dependency updates, sweep dependency backlog, or when a dependency bot upgrade caused CI failures that may be breaking changes needing investigation and fixing."
---
